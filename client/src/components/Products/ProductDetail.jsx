                            ...
                            <div className=" col-lg-6">
                                <div className="detail-content__desc">
                                    ...
                                    <div className="detail-content__desc-status">
                                        <h4>Trạng Thái: {productDetail.countInStock > 0  || countIn >= productDetail.countInStock ? <span className="instock">Còn hàng</span> : <span className="outstock">Hết hàng</span>}</h4>
                                    </div>
